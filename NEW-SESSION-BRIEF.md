...
- **75 static pages** build cleanly (64 conversion routes + hubs + about/privacy/
  terms + blog + homepage).
- **Merged PRs:** #1 foundation, #2 V1 engines, #3 ffmpeg <25MiB split fix,
  #4 PDF/audio fixes, #5 ESM-core audio fix + QA hardening, #6 official legal copy.
...
2. **Set up free email** via Cloudflare Email Routing (currently placeholder
   `support@zeroupload.app`; legal jurisdiction set to Dhaka, Bangladesh; dates
   "June 2026").
